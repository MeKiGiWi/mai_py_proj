...
type CurrentFiltersProps = {
  currentFilters: Pick<TCurrentFilters, 'selectedGroup' | 'selectedTeacher' | 'selectedPlace'>;
  setCurrentFilters: (update: Partial<TCurrentFilters>) => void;
};

export default function CurrentFilters({ currentFilters, setCurrentFilters }: CurrentFiltersProps) {
  return (
