"""
Django settings for mai_prod project.
...
SECRET_KEY = 'django-insecure-ag(^3lw)nkjo(qv2k(bi2-r16@gq^+#e6iz1s_e1c&xdmkq6+d'
...
WSGI_APPLICATION = 'mai_prod.wsgi.application'
